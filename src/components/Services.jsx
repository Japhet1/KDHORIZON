  ...
  return (
    <main className='flex flex-wrap justify-center md:space-y-5 lg:space-y-0 -mt-32 text-left'>
      <div className='md:max-w-lg lg:max-w-md overflow-hidden md:rounded-md lg:rounded-none shadow-lg bg-blue-500 px-6 py-5'>
        <div className='flex flex-wrap items-center'><GiCow className='text-6xl text-white'/><h1 className='font-bold text-white ms-4 text-4xl mb-2 py-5 font-gruppo'>Production Animale</h1></div>
      ...
      <div className='md:max-w-lg lg:max-w-lg overflow-hidden md:rounded-md lg:rounded-none shadow-lg bg-blue-700 px-6 py-5'>
        <div className='flex flex-wrap items-center'><GiTruck className='text-6xl text-white'/><h1 className='font-bold ms-4 text-white text-4xl mb-2 py-5 font-gruppo'>Transport</h1></div>
      ...
      <div className='md:max-w-lg lg:max-w-md overflow-hidden md:rounded-md lg:rounded-none shadow-lg bg-blue-500 px-6 py-5'>
        <div className='flex flex-wrap items-center'><GiGrain className='text-6xl text-white'/><h1 className='font-bold ms-4 text-white text-4xl mb-2 py-5 font-gruppo'>Production Agricole</h1></div>
