...
const NavBarAnimal = () => {
  return (
    <main className="">
        ...
        <div className="bg-animal text-center bg-center">
          <div className="bg-gray-700 py-40 md:p-40 lg:p-48 mb-auto bg-opacity-50">
            <h1 className="text-4xl md:text-7xl lg:text-7xl font-gruppo text-white font-bold">Production Animale</h1>
          </div>
        </div>
    </main>
  )
