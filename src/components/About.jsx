            ...
            <div className="flex flex-wrap justify-center mb-10 gap-20">
                <div className="max-w-2xl p-8 text-left">
                    ...
                    <div className="mt-10 lg:ms-10">
                        <h1 className="text-3xl text-black font-bold font-leelawadee mb-5">Notre vision<AiOutlineLine className="text-green-700" /></h1>
                ...
                <div className="max-w-2xl p-8 text-left items-center">
                    <div className="lg:mt-16">
                        <h1 className="text-3xl text-black font-bold font-leelawadee mb-5">Notre mission<AiOutlineLine className="text-green-700" /></h1>
                    ...
                    <div className="mt-40 md:mt-28 lg:mt-40">
                        <h1 className="text-3xl text-black font-bold font-leelawadee mb-5">Nos Valeurs<AiOutlineLine className="text-green-700" /></h1>
