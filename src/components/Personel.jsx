  ...
  return (
    <main className="py-20">
        <div className="text-center items-center mb-10 text-black">
            <h1 className="font-bold text-4xl md:text-5xl font-kanit">Personnel</h1>
        ...
        <div className="flex flex-wrap justify-center gap-16">
            ...
            <div className="max-w-lg bg-white shadow-lg">
                ...
                <h1 className="text-xl md:text-2xl font-semibold text-black mt-10 mb-3 text-center font-kanit">Klohoun Espoir</h1>
                <h1 className="text-gray-500 text-lg text-center mb-5 font-nunito">Manager</h1>
            </div>
            <div className="max-w-lg bg-white  shadow-lg">
