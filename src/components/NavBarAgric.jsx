...
const NavBarAgric = () => {
  return (
    <main className="">
        ...
        <div className="bg-agric text-center bg-center">
          <div className="bg-gray-700 py-40 md:p-40 lg:p-48 mb-auto bg-opacity-50">
            <h1 className="text-4xl md:text-7xl lg:text-7xl font-gruppo text-white font-bold">Production Agricole</h1>
          </div>
        </div>
    </main>
  )
